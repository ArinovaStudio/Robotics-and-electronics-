...
-- CreateEnum
CREATE TYPE "ProductAvailability" AS ENUM ('IN_STOCK', 'OUT_OF_STOCK', 'PREORDER', 'BACKORDER');
...
CREATE TABLE "Product" (
    ...
    "salePrice" JSONB,
    "salePriceEffectiveDate" JSONB,
    "costOfGoodsSold" JSONB,
    ...
    "productWidth" JSONB,
    "productWeight" JSONB,
    "shippingWeight" JSONB,
    "shippingHeight" JSONB,
    "shippingLength" JSONB,
    "shippingWidth" JSONB,
    "shipping" JSONB[],
    "freeShippingThreshold" JSONB[],
