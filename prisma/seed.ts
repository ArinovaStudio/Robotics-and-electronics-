...
async function main() {
  ...
  const customers = [];
  const customerData = [
    { name: 'Rahul Sharma', email: 'rahul@example.com', phone: '9876500001', verified: true },
    { name: 'Priya Patel', email: 'priya@example.com', phone: '9876500002', verified: true },
    { name: 'Amit Kumar', email: 'amit@example.com', phone: '9876500003', verified: false },
  ];
  ...
  const rahulAddress = await prisma.address.findFirst({ where: { userId: customers[0].id } });
  const priyaAddress = await prisma.address.findFirst({ where: { userId: customers[1].id } });
      ...
      data: {
        ...
        items: {
          create: [{
            ...
            productSnapshot: { title: product1.title, image: product1.imageLink }
          }]
        },
        payment: {
          create: {
        ...
        items: {
          create: [
            ...
            },
            {
              ...
              productSnapshot: { title: product2.title, image: product2.imageLink }
            }
          ]
        },
        payment: {
