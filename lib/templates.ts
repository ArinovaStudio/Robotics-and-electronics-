    ...
    <html>
      <head>
        <style>
          ...
          .header { background-color: #f0b31e; color: #000; padding: 20px; text-align: center; border-radius: 5px 5px 0 0; }
          .content { background-color: #f9f9f9; padding: 30px; border-radius: 0 0 5px 5px; }
          .otp { font-size: 32px; font-weight: bold; color: #f0b31e; text-align: center; padding: 20px; background-color: white; border-radius: 5px; margin: 20px 0; letter-spacing: 5px; }
    ...
    <html>
      <head>
        <style>
          ...
          .total-row { font-size: 18px; font-weight: bold; color: #f0b31e; }
          .cod-badge { display: inline-block; background-color: #f0b31e; color: #000; padding: 4px 10px; border-radius: 4px; font-size: 12px; font-weight: bold; margin-bottom: 15px;}
        </style>
      </head>
      <body>
        <div class="container">
  ...
  if (newStatus === "SHIPPED" && trackingNumber) {
    trackingHtml = `
      <div style="margin-top: 20px; padding: 20px; background-color: white; border: 1px solid #eee; border-radius: 5px;">
        <p style="margin: 0 0 10px 0; font-weight: bold; color: #f0b31e;">Tracking Information:</p>
        <p style="margin: 0; color: #333;">Tracking Number: <strong>${trackingNumber}</strong></p>
        ${trackingUrl ? `<p style="margin: 15px 0 0 0;"><a href="${trackingUrl}" style="background-color: #f0b31e; color: #000; padding: 8px 15px; text-decoration: none; border-radius: 4px; font-size: 14px; display: inline-block; font-weight: bold;">Track Your Package</a></p>` : ""}
      </div>
    `;
  }
    ...
    <html>
      <head>
        <style>
          ...
          .header { background-color: #f0b31e; color: #000; padding: 20px; text-align: center; border-radius: 5px 5px 0 0; }
          .content { background-color: #f9f9f9; padding: 30px; border-radius: 0 0 5px 5px; }
          .status-badge { display: inline-block; padding: 5px 15px; background-color: #f0b31e; color: #000; border-radius: 20px; font-weight: bold; font-size: 14px; margin-top: 5px; }
          .footer { text-align: center; margin-top: 20px; color: #666; font-size: 12px; }
          .order-info { margin: 20px 0; padding: 15px; background-color: #fff; border-radius: 5px; border-left: 4px solid #f0b31e; }
        </style>
      </head>
      <body>
        <div class="container">
    ...
    <html>
      <head>
        <style>
          ...
          .header { background-color: #f0b31e; color: #000; padding: 20px; text-align: center; border-radius: 5px 5px 0 0; }
          .content { background-color: #f9f9f9; padding: 30px; border-radius: 0 0 5px 5px; }
          .label { font-weight: bold; color: #f0b31e; font-size: 14px; text-transform: uppercase; letter-spacing: 1px; margin-top: 15px; }
    ...
    <html>
      <head>
        <style>
          ...
          .btn { display: inline-block; background-color: #f0b31e; color: #000; padding: 12px 24px; text-decoration: none; font-weight: bold; border-radius: 5px; margin-top: 20px; }
          .footer { text-align: center; margin-top: 20px; color: #666; font-size: 12px; }
        </style>
      </head>
      <body>
