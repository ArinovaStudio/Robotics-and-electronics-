    ...
    return (
      <div className="min-h-screen bg-white dark:bg-[#0a0a0a] flex flex-col justify-center items-center px-6 py-16">
        <div className="w-full max-w-md border p-8 sm:p-10 text-center" style={{ borderColor: BORDER }}>
          ...
          <Link href="/register" className="font-mono text-sm font-semibold hover:underline" style={{ color: ACCENT }}>
            Go to Register
          </Link>
        </div>
      </div>
    ...
    <div className="min-h-screen bg-white dark:bg-[#0a0a0a] flex flex-col justify-center items-center px-6 py-16">
      <div className="w-full max-w-md border p-8 sm:p-10" style={{ borderColor: BORDER }}>
        <div className="text-center mb-8">
          ...
          <p className="font-mono text-xs font-semibold mt-1" style={{ color: ACCENT }}>
            {email}
          </p>
        </div>
        ...
        <form onSubmit={handleVerifyOTP} className="space-y-5">
          ...
          <button
            ...
            className="w-full h-12 flex items-center justify-center gap-2 font-dm-sans text-xs font-semibold uppercase tracking-widest text-white transition-opacity hover:opacity-90 disabled:opacity-50 disabled:cursor-not-allowed"
            style={{ backgroundColor: ACCENT }}
          >
            {isLoading ? (
              <>
        ...
        <div className="mt-6 text-center">
          ...
          <button
            ...
            className="font-mono text-xs font-semibold hover:underline disabled:opacity-50"
            style={{ color: ACCENT }}
          >
