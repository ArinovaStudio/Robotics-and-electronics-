...
function LoginForm() {
  ...
  const [loginMethod, setLoginMethod] = useState<"jwt" | "nextauth">("jwt"); // Default to JWT

  const [isLoading, setIsLoading] = useState(false);
  const [error, setError] = useState("");
  const isVerified = searchParams.get("verified") === "true";

  // JWT Login - Direct API call
  ...
  const handleLogin =
    loginMethod === "jwt" ? handleJWTLogin : handleNextAuthLogin;
